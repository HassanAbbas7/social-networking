...
const t = getTranslations(language).singleUpload;

const activeSectorOptions = language === "nl" ? sectorOptionsNl : sectorOptions;

const getFieldLabel = (column) => {
  return t.fields?.[column] || column.replace(/_/g, " ");
};

const getPlaceholder = (column) => {
  return t.placeholders?.[column] || column.replace(/_/g, " ");
};
    ...
    <form onSubmit={handleSubmit} className="mt-6">
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row">
        {!data && (
          ...
          >
            {isUploading ? t.uploading : t.uploadEntry}
          </button>
        )}
        ...
        {data && (
          ...
          >
            {isDownloadingQr ? t.generating : t.downloadQr}
          </button>
        )}
      </div>
    </form>
